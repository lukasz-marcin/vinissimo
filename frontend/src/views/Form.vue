<template>
    <section id="wineForm" class="bg-bg">
        <!-- main div -->
        <div class="container max-w-6xl mx-auto py-12 px-5">

            <h1 class="text-center text-5xl font-extrabold text-textDark mb-10">Wino czerwone</h1>

            <form class="w-full space-y-14" @submit.prevent="handleSubmit" novalidate>

                <!-- first section -->
                <div
                    class="flex flex-col items-center space-y-8 md:space-y-0 md:flex-row md:space-x-10 px-5 py-8 rounded-md bg-wineRedDark shadow-xl">
                    ...
                    <div class="flex flex-col w-full md:w-1/2 space-y-8">
                        ...
                        <div class="flex space-x-5 items-center">
                            <label for="name" class="text-textLight text-lg md:text-xl">Nazwa</label>
                            <input id="name"
                                class="bg-wineRedLight rounded-lg py-2 px-2 focus:outline-none focus:ring-white focus:bg-wineRed focus:text-textLight focus:ring duration-150 w-full"
                                type="text" placeholder="Wprowadź nazwę wina" required v-model="wineData.name"></input>
                        </div>

                        <!-- region -->
                        <div class="flex space-x-5 items-center">
                            <label for="region" class="text-textLight text-lg md:text-xl whitespace-nowrap">Kraj /
                                Region</label>
                            <input id="region"
                                class="bg-wineRedLight rounded-lg py-2 px-2 focus:outline-none focus:ring-white focus:bg-wineRed focus:text-textLight focus:ring duration-150 w-full"
                                type="text" placeholder="Wprowadź kraj / region pochodzenia" required
                                v-model="wineData.region"></input>
                        </div>

                        <!-- variety -->
                        <div class="flex space-x-5 items-center">
                            <label for="variety" class="text-textLight text-lg md:text-xl">Szczep(y)</label>
                            <input id="variety"
                                class="bg-wineRedLight rounded-lg py-2 px-2 focus:outline-none focus:ring-white focus:bg-wineRed focus:text-textLight focus:ring duration-150 w-full"
                                type="text" placeholder="Wprowadź szczep(y)" required
                                v-model="wineData.variety"></input>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col w-full md:w-1/2 space-y-8">
                        <!-- year -->
                        <div class="flex space-x-5 items-center">
                            <label for="year" class="text-textLight text-lg md:text-xl">Rocznik</label>
                            <input id="year"
                                class="bg-wineRedLight rounded-lg py-2 px-2 focus:outline-none focus:ring-white focus:bg-wineRed focus:text-textLight focus:ring duration-150 w-full"
                                type="text" placeholder="Wprowadź rocznik wina" required
                                v-model="wineData.year"></input>
                        </div>

                        <!-- place -->
                        <div class="flex space-x-5 items-center">
                            <label for="place" class="text-textLight text-lg md:text-xl whitespace-nowrap">Miejsce
                                zakupu</label>
                            <input id="place"
                                class="bg-wineRedLight rounded-lg py-2 px-2 focus:outline-none focus:ring-white focus:bg-wineRed focus:text-textLight focus:ring duration-150 w-full"
                                type="text" placeholder="Wprowadź miejsce zakupu" required
                                v-model="wineData.place"></input>
                        </div>

                        <!-- price -->
                        <div class="flex space-x-5 items-center">
                            <label for="price" class="text-textLight text-lg md:text-xl">Cena</label>
                            <input id="price"
                                class="bg-wineRedLight rounded-lg py-2 px-2 focus:outline-none focus:ring-white focus:bg-wineRed focus:text-textLight focus:ring duration-150 w-full"
                                type="text" placeholder="Wprowadź cenę" required v-model="wineData.price"></input>
                        </div>
                    </div>
                ...
                <!-- second section -->
                <div
                    class="flex flex-col space-y-8 md:space-y-0 px-5 py-8 md:flex-row md:space-x-10 bg-wineRed w-full rounded-md shadow-xl">

                    <!-- first card -->
                    <div
                        class="w-full md:w-1/3 bg-wineRedDark flex flex-col text-textLight space-y-8 px-4 py-6 rounded-lg shadow-lg">
                        ...
                        <div class="flex flex-col space-y-8">
                            ...
                            <div class="flex space-x-5 items-center">
                                ...
                                <div class="w-full flex items-center space-x-4">
                                    <input id="intensity" type="range" min="0" max="100" v-model="wineData.intensity"
                                        :style="sliderStyle"
                                        class="w-full h-2 rounded-lg appearance-none cursor-pointer accent-white">
                            ...
                            <div class="flex space-x-5 items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <div v-if="isColorOpen" @click="isColorOpen = false"
                                    ...
                                    <ul v-if="isColorOpen"
                                        ...
                                        <li v-for="(option, index) in colorOptions" :key="index"
                            ...
                            <div class="flex space-x-5 items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <div v-if="isOtherOpen" @click="isOtherOpen = false"
                                        class="fixed inset-0 z-10 cursor-default">
                                    </div>
                    ...
                    <!-- second card -->
                    <div class="w-full md:w-1/3 bg-wineRedDark flex flex-col text-textLight rounded-lg shadow-lg">
                        <h3 class="text-2xl font-bold text-center">Aromaty</h3>
                    </div>

                    <!-- third card -->
                    <div class="w-full md:w-1/3 bg-wineRedDark flex flex-col text-textLight rounded-lg shadow-lg">
                        <h3 class="text-2xl font-bold text-center">Smak</h3>
                    </div>
                </div>
